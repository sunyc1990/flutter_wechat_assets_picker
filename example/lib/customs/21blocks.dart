...
const Color _themeColor = Color(0xffC5D500);

class MultiBlockAssetPicker extends StatefulWidget {
  const MultiBlockAssetPicker({super.key});

  @override
  State<MultiBlockAssetPicker> createState() => _MultiBlockAssetPickerState();
}

class _MultiBlockAssetPickerState extends State<MultiBlockAssetPicker> {
  ...
  Future<void> callPicker(BuildContext context) async {
    ...
    final DefaultAssetPickerProvider provider = DefaultAssetPickerProvider(
      ...
      maxAssets: maxAssets, requestType: RequestType.common
    );
...
class MultiTabAssetPickerBuilder extends DefaultAssetPickerBuilderDelegate {
      ...
      body: TabBarView(
        ...
        children: <Widget>[
          ...
          ChangeNotifierProvider<DefaultAssetPickerProvider>.value(
            ...
            builder: (BuildContext context, _) => _buildGrid2(context),
          ),
        ],
      ),
    );
  ...
  @override
  Widget build(BuildContext context) {
    EventBusUtils.eventBus.on<CameraEvent>().listen((event) {
      print(event.entity);
      List<AssetEntity> assets = <AssetEntity>[];
      assets.add(event.entity!);
            ...
            children: [
              Expanded(child: TabBarView(
                ...
                children: [
                  ...
                  CameraPicker.pickCamera(context,(BuildContext context, AssetEntity result){
              ...
              TabBar(
                ...
                tabs:  const [
                  Padding(
                    padding: EdgeInsets.only(bottom: 18.0,top: 12),
                    child: Text('相册'),
                  ),
                  Padding(
                    padding: EdgeInsets.only(bottom: 18.0,top: 12),
